...
function cartDrawer(tableNumber) {
    return {
        ...
        addItem(id, name, price, image) {
            if (!this.cart[id]) this.cart[id] = { name, price: parseFloat(price), qty: 1, image };
        ...
        showToast(msg, error = false) {
            ...
            toast.className = `fixed bottom-5 right-5 px-4 py-2 rounded shadow-lg text-white ${error ? 'bg-red-600' : 'bg-green-600'}`;
